  ...
  return (
    <div className="min-h-screen pt-24 pb-16 relative overflow-hidden bg-gradient-to-b from-blue-50 via-white to-purple-50">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {/* Gradient Orbs */}
        <div className="absolute top-20 left-10 w-96 h-96 rounded-full blur-3xl opacity-20 animate-pulse bg-blue-300" style={{ animationDuration: '4s' }}></div>
        <div className="absolute top-1/3 right-10 w-80 h-80 rounded-full blur-3xl opacity-20 animate-pulse bg-purple-300" style={{ animationDuration: '6s', animationDelay: '1s' }}></div>
        <div className="absolute bottom-20 left-1/3 w-72 h-72 rounded-full blur-3xl opacity-20 animate-pulse bg-pink-300" style={{ animationDuration: '5s', animationDelay: '2s' }}></div>
        
        {/* Floating Particles */}
        <div className="absolute top-1/4 left-1/4 w-2 h-2 rounded-full bg-blue-500 opacity-60 animate-pulse"></div>
        <div className="absolute top-1/3 right-1/3 w-3 h-3 rounded-full bg-purple-500 opacity-40 animate-pulse" style={{ animationDelay: '1s' }}></div>
        <div className="absolute bottom-1/4 left-1/3 w-2 h-2 rounded-full bg-pink-500 opacity-50 animate-pulse" style={{ animationDelay: '2s' }}></div>
      </div>
