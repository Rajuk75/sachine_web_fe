...
const TermsOfService = () => {
  ...
  return (
    <div className="min-h-screen pt-24 pb-16 relative overflow-hidden bg-gradient-to-b from-purple-50 via-white to-blue-50">
      {/* Animated Background Elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {/* Gradient Orbs */}
        <div className="absolute top-20 right-10 w-96 h-96 rounded-full blur-3xl opacity-20 animate-pulse bg-purple-300" style={{ animationDuration: '5s' }}></div>
        <div className="absolute top-1/2 left-10 w-80 h-80 rounded-full blur-3xl opacity-20 animate-pulse bg-blue-300" style={{ animationDuration: '7s', animationDelay: '1s' }}></div>
        <div className="absolute bottom-20 right-1/3 w-72 h-72 rounded-full blur-3xl opacity-20 animate-pulse bg-pink-300" style={{ animationDuration: '6s', animationDelay: '2s' }}></div>
        
        {/* Floating Particles */}
        <div className="absolute top-1/3 left-1/3 w-2 h-2 rounded-full bg-purple-500 opacity-60 animate-pulse"></div>
        <div className="absolute top-1/2 right-1/4 w-3 h-3 rounded-full bg-blue-500 opacity-40 animate-pulse" style={{ animationDelay: '1s' }}></div>
        <div className="absolute bottom-1/3 left-1/4 w-2 h-2 rounded-full bg-pink-500 opacity-50 animate-pulse" style={{ animationDelay: '2s' }}></div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Content */}
        <div className="rounded-2xl p-8 md:p-12 backdrop-blur-sm animate-fade-in-up bg-white/90 border border-gray-200 shadow-2xl shadow-purple-200/50" style={{ animationDelay: '0.2s' }}>
