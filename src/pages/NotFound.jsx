  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 left-20 w-96 h-96 rounded-full blur-3xl opacity-20 animate-pulse bg-blue-400"></div>
        <div className="absolute bottom-20 right-20 w-96 h-96 rounded-full blur-3xl opacity-20 animate-pulse bg-purple-400" style={{ animationDelay: '1s' }}></div>
      </div>
      ...
      <div className="text-center relative z-10 px-4">
        ...
        <div className="flex flex-wrap justify-center gap-4 animate-fade-in" style={{ animationDelay: '0.4s' }}>
          ...
          <button
            onClick={() => navigate(-1)}
            className="px-8 py-4 rounded-xl font-semibold hover:scale-105 transition-all bg-white text-gray-900 hover:bg-gray-50 border border-gray-300 shadow-lg"
          >
            Go Back
          </button>
        </div>
