  ...
  return (
    <section className="relative py-2 overflow-hidden">
      <div className="max-w-[85rem] mx-auto">
        <div className={`w-full relative rounded-[calc(3rem-2px)] overflow-hidden ${
          theme === 'dark' 
            ...
            <div className="flex overflow-hidden py-4 relative group">
              ...
              <div className={`absolute left-0 top-0 bottom-0 w-32 z-10 bg-gradient-to-r ${
                theme === 'dark' ? 'from-gray-900/80 to-transparent' : 'from-white/80 to-transparent'
              }`}></div>
              <div className={`absolute right-0 top-0 bottom-0 w-32 z-10 bg-gradient-to-l ${
                theme === 'dark' ? 'from-gray-900/80 to-transparent' : 'from-white/80 to-transparent'
              }`}></div>
